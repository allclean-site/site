...
const MAP = {
  ...
  'Уборка квартир': 'Curățenie apartamente',
  'Мойка фасадов': 'Spălarea fațadelor',
  'Чистка ковров': 'Curățare covoare',
  'Чистка мебели': 'Curățare mobilă',
  'Уборка складов': 'Curățenie depozite',
  'Уборка магазинов': 'Curățenie magazine',
  'Дезинфекция производств': 'Dezinfecție producție',
  ...
  'ВЫ ГОТОВЫ': 'SUNTEȚI GATA',
  'К ПОЛНОЙ ЧИСТОТЕ?': 'PENTRU CURĂȚENIE COMPLETĂ?',
  ...
  '“Я мама двоих детей, и дома быстро становится беспорядок. Пробовала разные службы - делали по минимуму. С All Clean наконец-то не нужно ничего перепроверять.”': '„Sunt mamă a doi copii, iar acasă devine repede dezordine. Am încercat diferite firme - făceau minimul. Cu All Clean în sfârșit nu trebuie să verific nimic.”',
  ...
  '“Возвращаться домой и не думать об уборке - прекрасно. Спасибо.”': '„Să mă întorc acasă și să nu mă mai gândesc la curățenie - minunat. Mulțumesc.”',
  ...
  '“Честно, сомневалась, что найду нормальный клининг в Кишинёве. Все либо спешили, либо халтурили. Эта команда удивила: всё аккуратно, по полочкам, даже маленькую квартиру преобразили.”': '„Sincer, mă îndoiam că găsesc o firmă bună de curățenie în Chișinău. Toți ori se grăbeau, ori făceau de mântuială. Echipa m-a surprins: totul ordonat, chiar și un apartament mic l-au transformat.”',
  ...
  '“Искали уборку с экосредствами, потому что есть домашние животные. Спасибо вашей команде”': '„Căutam curățenie cu produse ecologice, pentru că avem animale de companie. Mulțumim echipei voastre”',
  ...
  'Общие': 'Generale',
  'Уборка и оборудование': 'Curățenie și echipament',
  'Запись и условия': 'Programare și condiții',
  ...
  'ЛЮДИ ДОВЕРЯЮТ': 'OAMENII AU ÎNCREDERE',
  '4.9/5 РЕЙТИНГ': 'RATING 4,9/5',
  ...
  'Чаевые необязательны, но всегда приятны. Вы можете оставить их наличными или картой после уборки.': 'Bacșișul nu este obligatoriu, dar este mereu apreciat. Îl puteți lăsa în numerar sau cu cardul după curățenie.',
  'Можно ли попросить конкретные средства (например, без запаха)?': 'Pot cere produse specifice (de exemplu, fără miros)?',
  'Да — просто укажите это в комментарии при бронировании, и мы учтём пожелание.': 'Da — menționați acest lucru în comentariul de la rezervare și vom ține cont de preferință.',
  'Вы передвигаете мебель?': 'Mutați mobila?',
  'Мы передвигаем лёгкие предметы, но не тяжёлую мебель — из соображений безопасности.': 'Mutăm obiectele ușoare, dar nu mobila grea — din motive de siguranță.',
  'Моете ли вы посуду и стираете ли бельё?': 'Spălați vasele sau faceți spălătorie?',
  'Лёгкое мытьё посуды включено. Стирка не включена, если не добавлена как дополнительная услуга.': 'Spălarea ușoară a vaselor este inclusă. Spălătoria nu este inclusă decât dacă este adăugată ca serviciu suplimentar.',
  'Убираете ли вы после ремонта или строительства?': 'Faceți curățenie după renovare sau construcție?',
  'Да — наша уборка после ремонта включает удаление пыли, чистку поверхностей и полов после работы строителей.': 'Da — curățenia noastră post-renovare include îndepărtarea prafului, curățarea suprafețelor și a podelelor după plecarea constructorilor.',
  'Можно ли заказать разовую уборку?': 'Pot comanda o curățenie unică?',
  'Да — доступны разовая, регулярная и генеральная уборка.': 'Da — sunt disponibile curățenia unică, recurentă și generală.',
  'За сколько нужно бронировать уборку?': 'Cu cât timp înainte trebuie să rezerv curățenia?',
  'Рекомендуем бронировать за 2–3 дня. Иногда есть свободные слоты и на тот же день.': 'Recomandăm rezervarea cu 2–3 zile înainte. Uneori sunt disponibile sloturi chiar în aceeași zi.',
  'Что делать, если нужно отменить или перенести уборку?': 'Ce fac dacă trebuie să anulez sau să reprogramez curățenia?',
  'Вы можете перенести или отменить запись бесплатно не позднее чем за 24 часа до визита.': 'Puteți reprograma sau anula gratuit cu cel puțin 24 de ore înainte de vizită.',
  'Что если клинер опаздывает?': 'Ce se întâmplă dacă curățătorul întârzie?',
  'Если клинер задерживается, мы сразу же вас предупредим и при необходимости скорректируем время.': 'Dacă un curățător întârzie, vă anunțăm imediat și ajustăm ora dacă este necesar.',
  'Что если меня не устроит качество уборки?': 'Ce fac dacă nu sunt mulțumit de calitatea curățeniei?',
  'Свяжитесь с нами в течение 24 часов — бесплатно отправим клинера повторно, без лишних вопросов.': 'Contactați-ne în 24 de ore — trimitem gratuit un curățător din nou, fără întrebări.',
  'Нужно ли быть дома во время уборки?': 'Trebuie să fiu acasă în timpul curățeniei?',
  'Нет — главное, чтобы у нас был доступ в квартиру. Многие клиенты оставляют ключи консьержу.': 'Nu — important este să avem acces în apartament. Mulți clienți lasă cheile la portar.',
  'Как оплатить уборку?': 'Cum plătesc curățenia?',
  'Оплата происходит безопасно онлайн при бронировании. Наличные не нужны.': 'Plata se face în siguranță online la rezervare. Nu este nevoie de numerar.',
  'Есть ли скидки на регулярную уборку?': 'Există reduceri pentru curățenia recurentă?',
  'Да — при еженедельном, раз в две недели и ежемесячном графике действует автоматическая скидка на каждую уборку.': 'Da — pentru programul săptămânal, la două săptămâni sau lunar se aplică automat o reducere la fiecare curățenie.',
};
