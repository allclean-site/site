...
(function () {
  ...
  var BLOCKS = {
    ...
    image_text: { name: '🖼 Картинка + текст', html: '<div class="padding-global"><div class="w-layout-blockcontainer container-large w-container" style="padding-top:56px;padding-bottom:56px;display:grid;grid-template-columns:1fr 1fr;gap:32px;align-items:center"><img src="/images/content/book-about.avif" alt="" style="width:100%;border-radius:18px"/><div><div class="heading-style-h3">Заголовок</div><p class="text-size-large" style="margin-top:12px">Описание услуги или преимущества.</p></div></div></div>' },
    ...
    gallery: { name: '🖼 Галерея фото', html: '<div class="padding-global"><div class="w-layout-blockcontainer container-large w-container" style="padding-top:64px;padding-bottom:64px"><div class="heading-style-h2" style="text-align:center;margin-bottom:32px">НАШИ РАБОТЫ</div><div style="display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px"><img src="/images/content/book-about.avif" alt="" style="width:100%;aspect-ratio:4/3;object-fit:cover;border-radius:14px"/><img src="/images/content/book-about.avif" alt="" style="width:100%;aspect-ratio:4/3;object-fit:cover;border-radius:14px"/><img src="/images/content/book-about.avif" alt="" style="width:100%;aspect-ratio:4/3;object-fit:cover;border-radius:14px"/><img src="/images/content/book-about.avif" alt="" style="width:100%;aspect-ratio:4/3;object-fit:cover;border-radius:14px"/><img src="/images/content/book-about.avif" alt="" style="width:100%;aspect-ratio:4/3;object-fit:cover;border-radius:14px"/><img src="/images/content/book-about.avif" alt="" style="width:100%;aspect-ratio:4/3;object-fit:cover;border-radius:14px"/></div></div></div>' },
